module.exports = {
    ...
    siteTitleMeta: `Udaya Blog`, // This allows an alternative site title for meta data for pages.
    ...
    shortTitle: `Udaya Blog`, // Used for App manifest e.g. Mobile Home Screen
